...
export default function EditTask() {
  ...
  console.log("add-task: ", subjectID);
    ...
    <>
      <div className="container-add-task">
        ...
        <div className="content-add-task">
          ...
          <OptionalMenu subjectID={subjectID} optionalMenuItems={optionalMenuItems(subjectID, isAutoGeneration, setIsAutoGeneration)}/>
          <p>
        ...
        <Button
          ...
          onClick={() => handlePost(isAutoGeneration, selectedSettings, subjectID)}
