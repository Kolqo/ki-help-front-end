...
export default function DetailBuying(props) {
	// Можливо переробити, коли будеш підключати бек
	return (
		<div className='style-detail-buying'>
					...
					<div className='file'>
						...
						<div>
							...
							<p>
								Створено:{' '}
								<span>
									<TimeFormatter utcDateString={props.processTask.createdAt} />
								</span>
							</p>
						</div>
					</div>
			...
			{!props.isAutoGive && (
				<div className='developer-text'>{props.processTask.message}</div>
			)}
		</div>
	)
}
